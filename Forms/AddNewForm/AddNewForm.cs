    ...
    public partial class addNewForm : Form
    {
        ...
        private void btn_edit_Click(object sender, EventArgs e)
        {
            if (dgv_items.CurrentRow != null)
            {
                ...
                addNewSubForm add_new_dial_sub = new addNewSubForm(selectedTask);
                ...
                if (add_new_dial_sub.DialogResult == DialogResult.OK)
                {
                    ...
                    dgv_items.CurrentRow.SetValues(false, add_new_dial_sub.taskName, add_new_dial_sub.taskPriority,
